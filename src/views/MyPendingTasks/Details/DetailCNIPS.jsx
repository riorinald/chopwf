                ...
                <Row>
                    ...
                    <Col>
                        ...
                        <FormGroup row>
                            ...
                            <Col xs="12" md="8">
                                <Input disabled type="text" value={props.taskDetail.contractSignedByFirstPersonName} id="text-input" name="text-input" placeholder="Text" />
                            </Col>
                        </FormGroup>
                        <FormGroup row>
                            <Col md="4">
